 ...
 * 
 */
@WebServiceClient(name = "Lists", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "file:/D:/Temp/lists.wsdl")
public class Lists
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/Temp/lists.wsdl");
